...
import com.example.SpringBoot_Angular.model.enums.Perfil;
...
public class DBService {
    ...
    public void instanciaDB() {
        Tecnico tec1 = new Tecnico(null, "Vasco Sousa", "023.516.510-73", "vs@mail.pt", encoder.encode("123"));
        ...
        Cliente cli1 = new Cliente(null, "José Silva", "575.688.350-90", "js@mail.pt", encoder.encode("123"));
